...
<head>
<meta charset="UTF-8">
<title>/movie_info_insert/insertform.jsp</title>
...
<body>
   <div class="container">
      ...
      <form action="insert.jsp" method="post" id="insertForm">
         ...
         <div class="mb-3">
            <label class="form-label" for="movie_writer">admin@admin.com</label>
            <input class="form-control" type="text" name="movie_writer" id="movie_writer" />
         </div>
