...
<%
	...
	String writer=FreeCafeDao.getInstance().getData(num).getFree_writer();
	...
	//같으면 DB에서 삭제하고 응답하자	
	boolean isSuccess=FreeCafeDao.getInstance().delete(num);
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>/free_cafe/private/delete.jsp</title>
</head>
<body>
	<%if(isSuccess){ %>
	   <script>
