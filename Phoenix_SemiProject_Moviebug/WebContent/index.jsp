...
<body>
   ...
   <div class="container-xl index_content">
      <div class="row index_content02">
         <div class="row">
            <div class="col flex_box index_category">최신 인기</div>
         </div>
         <div class="row">
            <div class="col">
               <div class="row">
                     ...
                     <a
                        ...
                        <div class="card border-0">
                           <div class="card-body poster_info">
                              ...
                              <p class="card-text">
                                 <small class="text-muted"><%=dto.getMovie_nation()%>
                                    | <%=dto.getMovie_genre()%></small>
                              </p>
                              <p class="card-text">
                                 <%=dto.getMovie_story().length() >= 120 ? dto.getMovie_story() + "..." : dto.getMovie_story()%>
                              </p>
                              <p class="card-text">
                                 <small class="text-danger"><%=dto.getMovie_rating() != null ? "평점"+dto.getMovie_rating():"미개봉" %></small>
                              </p>
                           </div>
                           <img
                              src="<%=dto.getMovie_image() != null ? dto.getMovie_image() : "images/bigdata.jpg"%>"
         ...
         <div class="row align-self-center justify-content-center morewrapper">
            <a
               href="<%=request.getContextPath()%>/search/more.jsp?category=resent"
               title="" class="moreanchor">더보기</a>
         </div>
      </div>
               ...
               <div id="carouselExampleIndicators"
                  ...
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <a
                           href="http://www.cgv.co.kr/culture-event/event/detailViewUnited.aspx?seq=32640&menu=001">
                           <img
                           src="https://img.cgv.co.kr/Front/Main/2021/0706/16255375399870.jpg"
                           class="d-block w-100" alt="...">
                        </a>
                     </div>
                     <div class="carousel-item">
                        <a
                           href="http://www.cgv.co.kr/culture-event/event/detailViewUnited.aspx?seq=32651&menu=001">
                           <img
                           src="https://img.cgv.co.kr/Front/Main/2021/0707/16256253501280.jpg"
                           class="d-block w-100" alt="...">
                        </a>
                     </div>
                     <div class="carousel-item">
                        <a
                           href="http://www.cgv.co.kr/culture-event/event/detailViewUnited.aspx?seq=32625&menu=001">
                           <img
                           src="https://img.cgv.co.kr/Front/Main/2021/0709/16257922117860.jpg"
                           class="d-block w-100" alt="...">
                        </a>
                     </div>
                  </div>
      ...
      <div class="row index_content03">
         <div class="row">
            <div class="col flex_box index_category">여름 추천</div>
         </div>
         <div class="row">
            <div class="col">
         ...
         <div class="row align-self-center justify-content-center morewrapper">
            <a
               href="<%=request.getContextPath()%>/search/more.jsp?category=classic"
               title="" class="moreanchor">더보기</a>
         </div>
      </div>
