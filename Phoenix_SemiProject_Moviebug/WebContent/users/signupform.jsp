				  ...
				  <label class="form-check-label" for="signup_Check2">
				   ...
				   <a class="float-end" data-bs-toggle="offcanvas" 
					...
					<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight2" aria-labelledby="offcanvasRightLabel">
					  ...
					  <div class="offcanvas-body">
					    Netflix는 다음과 같은 회원 정보를 수신 및 보관합니다.<br/><br/>
<ul>
<li>회원이 Netflix에 제공하는 정보: Netflix는 다음 정보를 포함해 회원이 Netflix에 제공하는 정보를 수집합니다.</li><br/>
<ol>
<li>회원의 이름, 이메일 주소, 주소 또는 우편 번호, 결제 수단, 전화번호. Netflix는 회원이 Netflix 서비스 이용 과정에서 정보를 입력하는 경우, 고객 센터와 상담하는 경우 또는 설문 조사나 마케팅 프로모션에 참여하는 경우 등 다양한 방식을 통해 이러한 정보를 수집합니다.</li><br/>
<li>회원이 평가, 선호분야 설정, 계정 설정(웹사이트의 '계정' 섹션에 설정된 환경 설정 포함) 시 입력하는 정보 또는 Netflix 서비스나 타사를 통해 Netflix에 제공하는 정보.</li><br/>
</ol>
<li>Netflix가 자동으로 수집하는 정보: Netflix는 회원과 회원의 Netflix 서비스 이용, 회원과 Netflix의 커뮤니케이션 및 회원의 Netflix 광고 참여에 관한 정보뿐만 아니라 회원이 Netflix 서비스에 액세스하는 데 사용할 수 있는 네트워크, 네트워크 디바이스 및 컴퓨터 또는 기타 Netflix 이용이 가능한 디바이스(게임 시스템, 스마트 TV, 모바일 디바이스, 셋톱박스 및 기타 스트리밍 미디어 디바이스)와 관련된 정보를 수집합니다. 이 정보에는 다음이 포함됩니다.</li><br/>
<ol>
<li>콘텐츠 선택, 시청한 프로그램 및 검색어 등 회원의 Netflix 서비스 내 활동</li><br/>
<li>Netflix가 발송한 이메일과 문자 메시지, 그리고 Netflix가 푸시 알림 및 온라인 메시징 채널을 통해 보낸 메시지를 회원이 수신하고 이에 대응한 내용</li><br/>
<li>문의한 일시와 이유, 채팅 대화 기록, (전화 문의인 경우) 전화번호와 통화 녹음 등 회원의 Netflix 고객 센터 문의에 관한 세부 내용</li><br/>
<li>디바이스 ID 등의 고유 식별자(회원의 네트워크 디바이스 및 Wi-Fi 네트워크에서 Netflix 이용이 가능한 디바이스 포함).</li><br/>
...
Netflix 서비스 중 일부는 회원의 스마트 디바이스에 설치된 클라이언트와 애플리케이션을 이용해 회원이 이메일, 문자 메시지 및 소셜 미디어 등의 공유 애플리케이션으로 정보를 공유할 수 있는 도구를 포함할 수 있습니다.<br/><br/>
