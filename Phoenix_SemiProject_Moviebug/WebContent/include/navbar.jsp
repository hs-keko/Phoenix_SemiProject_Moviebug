				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-header search_bar">
				        <div class="modal-title flex_box search_bar_wrapper" id="exampleModalLabel">
        		            ...
        		            <form action="<%=request.getContextPath() %>/cafe/list.jsp" id="search_form" class="search_bar_form" method="get">
        		            		<input type="hidden" id="condition" name="condition" value="qna_title_content" />
