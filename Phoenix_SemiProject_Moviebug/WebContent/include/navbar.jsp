							...
							<div class="profile">
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-menu-lg-end">
										<li><a
											href="<%=request.getContextPath()%>/users/private/info.jsp"><button
													class="dropdown-item" type="button">내정보</button></a></li>
										<li><a
											href="<%=request.getContextPath()%>/users/logout.jsp"><button
													class="dropdown-item" type="button">로그아웃</button></a></li>
									</ul>
								</div>
								<%
									} else {
	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-header search_bar">
				<div class="modal-title flex_box search_bar_wrapper"
					id="exampleModalLabel">
					<form action="<%=request.getContextPath()%>/search/searchall.jsp"
						id="search_form" class="search_bar_form" method="get">
						<input type="hidden" id="condition" name="condition"
							value="movie_title_direc" />
						...
						<input id="nav_search_input" class="" type="text" id="keyword"
				...
				<button type="button" class="btn-close search_closeBtn"
	...
	<div class="offcanvas-body header_nav_offcanvas_body">
		<div>
			<ul class="nav flex-column">
				<li class="nav-item"><a class="nav-link active fs-2 fw-bold"
					aria-current="page"
					href="<%=request.getContextPath()%>/search/more.jsp?category=resent">최신
						인기 영화</a></li>
				<li class="nav-item"><a class="nav-link fs-2 fw-bold"
					href="<%=request.getContextPath()%>/search/more.jsp?category=classic">여름
						추천 영화</a></li>
				<li class="nav-item"><a class="nav-link fs-2 fw-bold"
					href="<%=request.getContextPath()%>/free_cafe/list.jsp">자유 게시판</a>
				</li>
				<li class="nav-item"><a class="nav-link fs-2 fw-bold"
					href="<%=request.getContextPath()%>/cafe/list.jsp">문의 게시판</a></li>
				<li class="nav-item"><a class="nav-link fs-2"
					href="<%=request.getContextPath()%>/movieinfo/movieinfo.jsp?movie_num=684"
					tabindex="-1" aria-disabled="true">#모가디슈</a> <a
					class="nav-link fs-2"
					href="<%=request.getContextPath()%>/movieinfo/movieinfo.jsp?movie_num=702"
					tabindex="-1" aria-disabled="true">#블랙위도우</a> <a
					class="nav-link fs-2"
					href="<%=request.getContextPath()%>/movieinfo/movieinfo.jsp?movie_num=701"
					tabindex="-1" aria-disabled="true">#랑종</a></li>
			</ul>
		</div>
	</div>
</div>